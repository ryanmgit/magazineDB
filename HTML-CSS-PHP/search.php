...
$query="select Subscriptionid, Magazinename, Subscriberfname, Subscriberlname, Subscriptiondate, Subscriptionperiod, City, State, Magazine from subscription left join subscriber on subscription.subscriptionid=subscriber.subscriptionid left join magazine on subscription.magazineid=magazine.magazineid where Subscriberfname' + $fname + ' and Subscriberlname' + $lname + ' and Email' + $email + ' and City' + $city + ' and State' + $state + ' and Magazine' + $magazine + ' group by subscriptionid";
